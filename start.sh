...
PORT="${PORT:-3720}"
DB_NAME="${PGDATABASE:-risk_investigation_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Risk Investigation Suite"
echo "======================================="
echo
...
echo "Starting risk investigation suite frontend on http://localhost:$PORT"
echo "Login: admin@risk-investigation.local / admin123"
