export const AUTH_COOKIE = 'risk_investigation_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@risk-investigation.local',
    password: 'admin123',
    firstName: 'Risk',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@risk-investigation.local',
    password: 'manager123',
    firstName: 'Risk',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@risk-investigation.local',
    password: 'analyst123',
    firstName: 'Risk',
    lastName: 'Analyst',
    role: 'analyst',
