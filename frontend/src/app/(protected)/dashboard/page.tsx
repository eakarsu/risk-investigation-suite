...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Risk Investigation Dashboard"
      subtitle="One merged risk and investigation view for cases, fraud, AML, claims, evidence, compliance, documents, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared risk and investigation jobs into one surface. Cases, alerts, evidence, claims, AML, risk assessments, compliance, and AI are presented as platform features.</div>
